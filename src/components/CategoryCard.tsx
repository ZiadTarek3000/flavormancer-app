...
export default function CategoryCard({ img, title, desc, price }: CategoryCardProps) {
  return (
    <div className="bg-white shadow-xl rounded-3xl p-6 w-64 text-center transition-all">
